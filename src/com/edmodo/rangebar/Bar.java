...
class Bar {
    ...
    int getNearestTickIndex(Thumb thumb) {
    	float tickX = ((thumb.getX() - mLeftX + mTickDistance / 2f) / mTickDistance);
    	if (tickX - (int)tickX > 0.500001f)
    		tickX = (int)tickX + 1;
    	else
    		tickX = (int)tickX;
    	
        final int nearestTickIndex = (int) tickX;
    ...
    private void drawTicks(Canvas canvas) {
        ...
        for (int i = 0; i < mNumSegments; i+=mTickStep) {
